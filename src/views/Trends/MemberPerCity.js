    ...
    render() {
        ...
        return (
            <div className="ChartWithLogarithmicAxis">
                ...
                <h4 className="heading-text">Top 5 topics {this.state.currentLocation.label} </h4>
                </div>
                ...
                <h5 >Description:</h5>
                <div>
                The above chart shows the estimate of total count of members widely spread in different locations at different time periods of all top 5 topics. 
                The top widely spread locations are New York, Chicago and San Francisco
                </div>
                </div>
                <div className="query-details">
                    ...
                    <div>
                       <ul>
                    <li>This estimation is helpful for tracking the members increased in cities and in tracking the topics that pupils are mostly interested.</li>
                    <li>Through this data, Meetup can easily access its success and helps them to implement innovative plans that indeed helpful for expansion of the company.</li>
                    </ul>
                    </div>
                </div>
                <div className="query-details">

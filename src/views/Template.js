...
import ActiveGroups from "./Trends/ActiveGroups"
import MemberPerCity from "./Trends/MemberPerCity"
import WidelySpreadGroups from "./Trends/WidelySpreadGroups"
import TopGroups from "./Trends/EventsVsYears"
import EventsVsYears from "./Trends/TopGroups"
    ...
    return (
		<div>
			<Navbar bg="dark" variant="dark">
				<button className="d-lg-none toggle-sidebar test-nav"><span className="navbar-toggler-icon"></span></button>
			  ...
			  <BrowserRouter>		  
					<Row>
						...
						<Nav to="/" className="flex-sm-column" id="sidebar">
							...
							<ListGroup.Item> <NavLink exact to="/active-groups">Active group count trend</NavLink></ListGroup.Item>
										<ListGroup.Item> <NavLink exact to="/widly_spread_groups">Widely Spread Groups Trend</NavLink></ListGroup.Item>									
										<ListGroup.Item> <NavLink exact to="/member_vs_city_stats">Top Topics Trend</NavLink></ListGroup.Item>
										<ListGroup.Item> <NavLink exact to="/category_events_vs_events">Events Growth</NavLink></ListGroup.Item>
										<ListGroup.Item> <NavLink exact to="/events_vs_years">Events Growth per year</NavLink></ListGroup.Item>
						...
						<Col xl={{ span: 7, offset: 3 }} lg={{ span: 8, offset: 3 }} xs={{ span: 8, offset: 2 }}>
							<Container>
								<div className="content">
									...
									<Route exact path="/widly_spread_groups" component= {WidelySpreadGroups}/>
									<Route exact path="/member_vs_city_stats" component= {MemberPerCity}/>
									<Route exact path="/category_events_vs_events" component= {TopGroups}/>
									<Route exact path="/events_vs_years" component= {EventsVsYears}/>
									<Route exact path="/trends" component={ColumnChart}/>
